							...
							<div class="clear-block">
								<div id="node-2" class="node">
									<div class="content clear-block">
										<form method="post"
											action="<%=path %>/manager/TangPoetry-show.action" name="glb">
											<select name="selects">
										...
										<%
										List poetrieList = (List)session.getAttribute("poetrieList");
										...
										<table width="100%" border="0" cellpadding="1" cellspacing="0">
											...
											<tr>
												<td><span style="FONT-SIZE: 12px"> <a
														href="manager/TangPoetry-show.action?selects=lbl_Author&keyword=<%= poe.getName()%>"><font
